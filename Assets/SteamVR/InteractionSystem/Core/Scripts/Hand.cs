...
namespace Valve.VR.InteractionSystem
{
	...
	public class Hand : MonoBehaviour
	{
        ...
        public GameObject ammoPouchRef;
        ...
        private bool canGrabAmmo = false;

        
        void ammoPouch()
        {

            //check it is the correct hand
            if (startingHandType == 0)
            {
                if (controller.GetHairTriggerDown())
                {
                   ...
                   {
                     if (col.transform.tag == "ammoPouch")
                     {
                        canGrabAmmo = true;
                     }
                  }
